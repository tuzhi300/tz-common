 ...
 */
@ApiModel(value = "分页查询请求限制")
@Data
public class RequestLimitQueryEntity extends PaginationQuery implements Serializable {
    ...
    * 接口标记，代码中唯一标识。
    */
    @Length(max = 250 ,message = "接口标记，代码中唯一标识。不能超过250个字符")
    @ApiModelProperty(value = "接口标记，代码中唯一标识。，最大长度：250", position = 2 )
    private String limitId;
    /**
    * 会话ID
    */
    @Length(max = 64 ,message = "会话ID不能超过64个字符")
    ...
    * 接口地址
    */
    @Length(max = 255 ,message = "接口地址不能超过255个字符")
